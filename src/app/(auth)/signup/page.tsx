        ...
        <div className="relative z-10 max-w-lg mt-auto mb-12">
          ...
          >
            ...
            <p className="text-lg text-zinc-400">
              Create an account and get instant access to powerful AI-driven tools designed specifically for digital content creators.
            </p>
          </motion.div>
        </div>
      </div>
        ...
        <div className="w-full max-w-md">
          ...
          >
            <div className="mb-10">
              ...
              <p className="text-zinc-400">Start building your CreatorOS workspace today.</p>
            </div>
            ...
            <p className="mt-8 text-center text-sm text-zinc-400">
              Already have an account? <Link href="/login" className="text-primary hover:text-primary/80 font-medium transition-colors">Log in</Link>
            </p>
          </motion.div>
        </div>
      </div>
